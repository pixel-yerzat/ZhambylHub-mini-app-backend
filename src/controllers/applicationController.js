...
const submitApplicationSchema = z.object({
  ...
  project_desc: z.string().nullish(),
  short_desc_kz: z.string().nullish(),
  category: z.string().nullish().default('AI & IT Solutions'),
  project_category: z.string().nullish(),
  stage: z.string().nullish().default('MVP / Prototype'),
  project_stage: z.string().nullish(),
  tag: z.string().nullish().default('Startup'),
  target_audience: z.string().nullish(),
  unique_value_prop: z.string().nullish(),
  founder_id: z.any().optional(),
  founder_name: z.string().nullish(),
  founder_phone: z.string().nullish(),
  founder_role: z.string().nullish(),
  team_members: z.string().nullish(),
  pdf_deck_url: z.string().nullish(),
  pdf_deck_name: z.string().nullish(),
  pdf_deck_size: z.string().nullish(),
  demo_url: z.string().nullish(),
  demo_link: z.string().nullish(),
  demo_or_github_url: z.string().nullish(),
  presentation_link: z.string().nullish(),
  logo_icon: z.string().nullish(),
